...
public class CreatingNewLeadsPage {
	...
	@FindBy(name="leadsource") private WebElement leadSourceDropdownTextField;
	...
	public WebElement getLeadSourceDropdownTextField() {
		return leadSourceDropdownTextField;
	}
	...
	public void CreateNewLead(String lname,String company,String title,String leadSource,String noOfEmp) {
		...
		new SeleniumUtility().selectOptionByValue(leadSourceDropdownTextField, leadSource);
